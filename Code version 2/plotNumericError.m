% With this script we compare the policy and value functions obtained
% numerically and analytically

global plotNumber

%% ------------------------------------------------------------------------ 
% PLOT POLICY FUNCTION (numerical and analytical solutions for savings as a function
% of assets in period 'whichyear')
...
%% ------------------------------------------------------------------------ 
% PLOT POLICY FUNCTION (numerical and analytical solutions for consumption as a function
% of assets in period 'whichyear')
...
%% ------------------------------------------------------------------------ 
% Plot the ratio of numerical and analytical solutions
plotNumber = plotNumber + 1;
figure(plotNumber);
    plot( Agrid(whichyear,plotNode1:plotNodeLast), ...
